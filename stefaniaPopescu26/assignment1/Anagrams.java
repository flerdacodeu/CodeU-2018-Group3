...
public class Anagrams {
    ...
    public boolean solve() {
        ...
        /*
            ...
            checking the words.
         */
        if (!areAnagrams(sentence1.toLowerCase(), sentence2.toLowerCase()))
            return false;
        ...
        /*
            ...
            been checked above.
         */
        String[] words1 = getWords(sentence1.toLowerCase());
        String[] words2 = getWords(sentence2.toLowerCase());
        ...
        for (i = 0; i < words1.length; i++) {
            if (!areAnagrams(words1[i], words2[i]))
                return false;
        }
